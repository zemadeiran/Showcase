...
export class Icon extends HTMLElement {
  ...
  get size() {
    return this.getAttribute('size') || 'w-5 h-5';
  }
  ...
  getIconPath(iconName) {
    const icons = {
      ...
      chevron: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>',
      ...
      chart: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>',
      ...
      // Default fallback
      default: '<circle cx="12" cy="12" r="10"></circle><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.09 9a3 3 0 015.83 1c0 2.5-3 2.5-3 2.5m.08 2h.01"></path>'
    };
  ...
  render() {
    const iconPath = this.getIconPath(this.name);
    const classes = `${this.size} ${this.iconClass}`.trim();
